...
//use ProCorpo\CRM\Controller\GraphDatabaseService;
...
$graphDb = new GraphDatabaseService('http://54.207.39.230:7474/');
...
// $secondNode->someOtherAttribute = 'blah blah blah2';
// $secondNode->save();
