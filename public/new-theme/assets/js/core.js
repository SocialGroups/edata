$(document).ready(function () {
    ...
    $('.grid .tools a.reload').live('click', function () {
    ...
    $('.widget-item > .controller .reload').live("click",function () {
    ...
    $('.widget-item > .controller .remove').live("click",function () {
        $(this).parent().parent().parent().addClass('animated fadeOut');
    ...
    $('.tiles .controller .reload').live("click",function () {
    ...
    $('.tiles .controller .remove').live("click",function () {
